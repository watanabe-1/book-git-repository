...
public class ChartColourThymeleafController {
   ...
   * @return リダイレクト先
   */
  @RequestMapping(value = "/thymeleaf/chartColour/delete", method = RequestMethod.POST)
   ...
   * @return リダイレクト先
   */
  @RequestMapping(value = "/thymeleaf/chartColour/changeActive", method = RequestMethod.POST)
   ...
   * @return 画面表示情報
   */
  @RequestMapping(value = "/thymeleaf/chartColour/index", method = RequestMethod.GET)
